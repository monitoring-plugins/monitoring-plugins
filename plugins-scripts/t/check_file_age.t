...
$result = MPTest->testCmd("./check_file_age -f $temp_file -w 1");
...
$result = MPTest->testCmd("./check_file_age -f $temp_file -c 1");
...
$result = MPTest->testCmd("./check_file_age -f $temp_file -c 1000 -W 100");
...
$result = MPTest->testCmd("./check_file_age -f /non/existent --ignore-missing");
cmp_ok( $result->return_code, '==', 0, "Honours --ignore-missing" );

$result = MPTest->testCmd("./check_file_age -f $temp_file -c 1000 -W 101");
cmp_ok( $result->return_code, '==', 1, "One byte too short" );

$result = MPTest->testCmd("./check_file_age -f $temp_file -c 1000 -C 101");
...
SKIP: {
    ...
    $result = MPTest->testCmd("./check_file_age -f $temp_file -w 0:1");
    ...
    $result = MPTest->testCmd("./check_file_age -f $temp_file -c 0:1");
