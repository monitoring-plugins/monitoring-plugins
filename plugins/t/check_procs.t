...
$result = MPTest->testCmd( "./check_procs -w 100000 -c 100000" );
...
$result = MPTest->testCmd( "./check_procs -w 100000 -c 100000 -s Z" );
...
$result = MPTest->testCmd( "./check_procs -w 0 -c 0" );
...
$result = MPTest->testCmd( "./check_procs -w 0 -c 0 -s Ss" );
...
$result = MPTest->testCmd( "./check_procs -w 0 -c 100000 -p 1" );
