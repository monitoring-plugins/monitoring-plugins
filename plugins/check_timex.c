...
*
* License: GPL
* Copyright (c) 2019 Monitoring Plugins Development Team
...
* https://github.com/monitoring-plugins/monitoring-plugins/pull/1415
*
...
print_help (void)
{
	...
	printf ("Copyright (c) 2019 Monitoring Plugins Development Team\n");
