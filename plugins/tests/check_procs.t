...
$result = MPTest->testCmd( "$command -C launchd -c 5" );
...
$result = MPTest->testCmd( "$command -X bash -c 5" );
...
SKIP: {
    ...
    $result = MPTest->testCmd( "$command -u 501 -w 39 -c 41" );
    ...
    $result = MPTest->testCmd( "$command -C launchd -u 501" );
...
SKIP: {
    ...
    $result = MPTest->testCmd( "$command -u -2 -w 2:2" );
    ...
    $result = MPTest->testCmd( "$command -u -2 -w 3:3" );
    ...
    $result = MPTest->testCmd( "$command -u -2 -a usb" );
...
SKIP: {
    ...
    $result = MPTest->testCmd( "$command --ereg-argument-array='mdworker.*501'" );
...
SKIP: {
    ...
    $result = MPTest->testCmd( "$cmd_etime -m ELAPSED -C apache2 -w 1000 -c 2000" );
...
$result = MPTest->testCmd( "$command --vsz 1000000" );
...
$result = MPTest->testCmd( "$command --rss 100000" );
...
$result = MPTest->testCmd( "$command -s S" );
...
$result = MPTest->testCmd( "$command -P 0.71" );
...
$result = MPTest->testCmd( "$command -P 0.70" );
...
$result = MPTest->testCmd( "$command --metric=CPU -w 8" );
...
SKIP: {
    ...
    $result = MPTest->testCmd( "$command --metric=CPU -w 1 -u 501 -v" );
...
$result = MPTest->testCmd( "$command --metric=VSZ -w 1200000 -v" );
...
$result = MPTest->testCmd( "$command --metric=RSS -c 70000 -v" );
...
$result = MPTest->testCmd( "$command --ereg-argument-array='(nosuchname|nosuch2name)'" );
